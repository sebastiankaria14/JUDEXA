"""
Judexa — Application Configuration
...
class Settings(BaseSettings):
    ...
    r2_bucket_name: str = "judexa-uploads"
    r2_public_url: str = ""
    ...
    port: int = 8000
    cors_origins: str = ""  # Comma-separated allowed origins, e.g. "http://localhost:4000,https://judexa.app"
