...
const FLOW_STEPS = [
  ...
  },
  {
    ...
    color: "accent.400",
    bgColor: "accent.500",
    mockLines: ["Generating invite link...", "judexa.com/invite/8x92m", "12 judges joined \u2705"],
  },
  {
          ...
          >
            <VStack spacing={6} align={{ base: "center", lg: "flex-start" }} textAlign={{ base: "center", lg: "left" }}>
              ...
              >
                ...
                Judexa unifies everything into a single, immersive view.
              </Text>
        ...
        <Container maxW="container.lg" py={8}>
          ...
          >
            ...
            <Text fontSize="xs" color="whiteAlpha.400">
              © {new Date().getFullYear()} Judexa. Hackathon judging, reimagined.
            </Text>
          </Flex>
        </Container>
      </Box>
